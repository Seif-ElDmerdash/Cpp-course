...
int main()
{
    ...
    cout << "Children must be taught how to think, not what to think" << endl;
    ...
    cout << "Children have never been very good at listening to their elders, but they have never failed to imitate them" << endl;
